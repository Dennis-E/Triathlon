...
| Location | Repository root (served at `https://dennis-e.github.io/Triathlon/social-preview.png`) |
...
|---|---|---|---|
| `favicon.ico` | multi-size (any) | Legacy/browser default request | `<link rel="icon" href="/Triathlon/favicon.ico" sizes="any">` |
| `favicon-16x16.png` | 16×16 | Small browser tab icon | `<link rel="icon" type="image/png" sizes="16x16">` |
| `favicon-32x32.png` | 32×32 | Standard browser tab icon | `<link rel="icon" type="image/png" sizes="32x32">` |
| `apple-touch-icon.png` | 180×180 | iOS home-screen icon | `<link rel="apple-touch-icon" sizes="180x180">` |
...
| `og:image` / `og:image:secure_url` | `https://dennis-e.github.io/Triathlon/social-preview.png` |
...
| `twitter:image` | `https://dennis-e.github.io/Triathlon/social-preview.png` |
